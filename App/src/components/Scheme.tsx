...
export default function Scheme() {
    ...
    const jsonData = `{"Pradhan Mantri Fasal Bima Yojana":{"data":"1706934002000","description":"To provide insurance coverage and financial support to the farmers in the event of failure of any of the notified crop as a result of natural calamities, pests & diseases"},"Krishi udan scheme":{"data":"1706934002000","description":"Krishi Udan Scheme was launched in August 2020 on international and national routes to assist farmers in transporting agricultural products to help improve their value realization"}}`;
          ...
          <a key={item.name} href={item.href} className="text-sm font-semibold leading-6 text-gray-900">
            ...
            <div className="relative isolate px-6 pt-14 lg:px-8">
                ...
                <div className="container mx-auto px-4 py-4 pt-10">
                    <h1 className="text-3xl font-bold mb-4">Government Agricultural Schemes</h1>
                    <div className="grid grid-cols-1 gap-4">
                        {Object.entries(parsedData).map(([name, { description }]) => (
